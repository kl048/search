...
class Subsession(BaseSubsession):
    def creating_session(self):
        ...
        if treatment in ['C', 'T'] and num_participants % self.session.config['players_per_group'] != 0:
            raise ValueError('Number of participants must be even for chat and team treatments.')
